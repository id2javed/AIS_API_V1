...
public class LiveVehicleResponse {
	...
	private int Seno;
	private String mapfencedata;
	
	
	public String getMapfencedata() {
		return mapfencedata;
	}
	public void setMapfencedata(String mapfencedata) {
		this.mapfencedata = mapfencedata;
	}
	public List<MapAlldataResponse> getDataarr() {
		return dataarr;
	}
